...
<div class="content-grid">
  ...
  <div class="card event-card">
    ...
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Arnold+Rim" alt="Arnold Rim">
    </div>
  ...
  <div class="card event-card">
    <h3>Calero</h3>
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Calero" alt="Calero">
    </div>
  ...
  <div class="card event-card">
    ...
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Cool+Canyon" alt="Cool Canyon">
    </div>
  ...
  <div class="card event-card">
    ...
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=CMDTRA" alt="CMDTRA (Mt Diablo)">
    </div>
  ...
  <div class="card event-card">
    <h3>Cowboy Camp</h3>
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Cowboy+Camp" alt="Cowboy Camp">
    </div>
  ...
  <div class="card event-card">
    <h3>Eel River</h3>
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Eel+River" alt="Eel River">
    </div>
  ...
  <div class="card event-card">
    <h3>Fall Fiesta & Georgetown</h3>
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Fall+Fiesta" alt="Fall Fiesta & Georgetown">
    </div>
  ...
  <div class="card event-card">
    ...
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Jackson+Forest" alt="Jackson Forest">
    </div>
  ...
  <div class="card event-card">
    ...
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Lake+Mendocino" alt="Lake Mendocino">
    </div>
  ...
  <div class="card event-card">
    <h3>Round Valley</h3>
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Round+Valley" alt="Round Valley">
    </div>
  ...
  <div class="card event-card">
    ...
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Spring+in+the+Redwoods" alt="Spring in the Redwoods">
    </div>
  ...
  <div class="card event-card card-featured">
    ...
    <div class="photo-container">
      <img src="https://via.placeholder.com/600x400?text=Mini-Conventions" alt="Mini-Conventions & More">
    </div>
