...
> [!NOTE]
> Understanding the technical difference between content files (Markdown) and static assets (PDFs) is crucial for correct site updates. See the [Content vs. Assets Guide](../content_vs_assets/) for a detailed comparison.
...
For complete instructions on adding articles, updating PDF archives, and managing site content, please refer to the [Site Administrator: Maintenance & Operations Guide](../admin_guide/).

For detailed information on how the site is deployed, hosted, and how to migrate ownership, please refer to the [Deployment & Infrastructure Guide](../deployment/).
