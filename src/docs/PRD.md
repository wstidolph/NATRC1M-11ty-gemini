...
- **Deployment & Hosting:** The site is hosted on GitHub Pages and automatically deployed via GitHub Actions. See the [Deployment & Infrastructure Guide](../deployment/) for technical details and migration instructions.
